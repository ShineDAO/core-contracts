...
import ".././Kassandra/KSAT.sol";

contract KassandraSeed is Crowdsale, Ownable{
    using SafeMath for uint256;
    enum Tiers {NoTier, Tier1, Tier2, Tier3, Tier4 }
    uint256 public relativeCap = 217390000000000000000;
    bool public isSaleOpenForAll = true;
    mapping(address => uint256) public contributions;
    mapping(address => uint256) public vestedBalances;
    mapping(address => uint256) public vestingPeriod;
    KSAT public shineToken; 
    ...
    function _processPurchase(address beneficiary, uint256 tokenAmount) internal {
        ...
        // deliver 100% of the tokens
        _deliverTokens(beneficiary, tokenAmount.mul(100).div(100));
